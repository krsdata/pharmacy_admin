<div class="form-body" style="background:#f4f4f4">
    <div class="alert alert-danger display-hide">
        <button class="close" data-close="alert"></button> Please fill the required field! </div>
   

    <div class="form-group {{ $errors->first('ndc', ' has-error') }}">
        <label class="control-label col-md-3">Please scan or enter the NDC # of the item you want to return<span class="required"> * </span></label>
        <div class="col-md-4"> 
    ...
    <div class="form-group {{ $errors->first('exp_date', ' has-error') }}">
        ...
        <div class="col-md-4"> 
            {!! Form::text('exp_date',$inventoryIntake->exp_date, ['class' => 'form-control','data-required'=>1,'placeholder'=>'mm/dd/yyyy'])  !!} 
